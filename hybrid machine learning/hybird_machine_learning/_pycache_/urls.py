"""hybrid_machine_learning URL Configuration
...
from hybrid_machine_learning import settings
...
urlpatterns = [
    ...
    url(r'^Botnet_Attack_Detection_Type/$', remoteuser.Botnet_Attack_Detection_Type, name="Botnet_Attack_Detection_Type"),
    ...
    url(r'^View_Prediction_Of_Botnet_Attack_Detection_Type_Ratio/$', serviceprovider.View_Prediction_Of_Botnet_Attack_Detection_Type_Ratio, name="View_Prediction_Of_Botnet_Attack_Detection_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Botnet_Attack_Detection_Type/$', serviceprovider.View_Prediction_Of_Botnet_Attack_Detection_Type, name="View_Prediction_Of_Botnet_Attack_Detection_Type"),
